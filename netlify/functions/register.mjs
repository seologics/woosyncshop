...
<body style="margin:0;padding:0;background:#0f1117;font-family:'DM Sans',Arial,sans-serif;color:#e2e8f0">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0f1117;padding:40px 0">
    ...
    // NOTE: No "voltooi je betaling" email here — the user is actively being redirected
    // to Mollie right now. Sending a payment reminder at this moment is confusing.
    // If they abandon payment, a dunning flow should handle follow-up separately.
